...
class BasicConv2d(nn.Module):
  """ 2D basic convolution + batch normalization block """
...
class RegressionNet(nn.Module):
  ...
  def __init__(self, num_in_channels = 3, num_classes=1000, aux_logits=False,
               transform_input=False):
    super(RegressionNet, self).__init__()
    self.aux_logits = aux_logits
    self.transform_input = transform_input
    self.Conv2d_1a_3x3 = BasicConv2d(num_in_channels, 32, kernel_size=3, stride=2)
